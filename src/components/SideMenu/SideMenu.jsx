...
const SideMenu = () => {
    return (
        <div className="w-auto md:w-1/6 border-r-2 p-4 flex flex-row md:flex-col items-center">
          <span className="text-[70px] pb-3 font-bold text-slate-800">ATS</span>
          <div className="flex flex-row md:flex-col items-start w-full text-xl font-semibold text-slate-700 mt-4 gap-2">
            <SideMenuHomeButton />
            <div className='w-full p-2 cursor-pointer hover:bg-gray-600 flex flex-row items-center justify-between'>Settings</div>
